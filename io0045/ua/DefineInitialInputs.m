...
%%
UserVar.MisExperiment='io0045';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0045/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0045';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1090.09';
UserVar.FinalOutputID='1090.10';
%%
...
CtrlVar.TotalTime=1090.83333333333;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0045/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0045/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
...
CtrlVar.ExplicitMeshRefinementCriteria(I).InfoLevel=2;
