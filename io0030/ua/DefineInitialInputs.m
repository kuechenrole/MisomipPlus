...
%%
UserVar.MisExperiment='io0030';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0030/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0030';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1043.09';
UserVar.FinalOutputID='1043.10';
%%
...
CtrlVar.TotalTime=1043.83333333333;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0030/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0030/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
