...
%%
UserVar.MisExperiment='io0038';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0038/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0038';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1001.06';
UserVar.FinalOutputID='1001.07';
%%
...
CtrlVar.TotalTime=1001.58333333333;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0038/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0038/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
