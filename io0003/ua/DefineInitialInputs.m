...
%%
UserVar.MisExperiment='io0003';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0003/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0003';
...
CtrlVar.TotalTime=1100;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0003/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0003/uarst/RestartMismipPlus-spinup_W.mat';
else
    CtrlVar.ResetTime=0;   
