...
%%
UserVar.MisExperiment='io0029';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0029/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0029';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1081.07';
UserVar.FinalOutputID='1081.08';
%%
...
CtrlVar.TotalTime=1081.66666666667;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0029/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0029/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
