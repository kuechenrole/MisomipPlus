...
%%
UserVar.MisExperiment='io0043';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0043/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0043';
...
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0043/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0043/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
...
CtrlVar.MeshSizeMin=50;%200    % min element size

CtrlVar.MaxNumberOfElements=8000e3;%250e3;           % max number of elements. If #elements larger then CtrlMeshSize/min/max are changed
...
CtrlVar.MeshAdapt.GLrange=[20000 5000 ; 5000 500; 1000 250; 250 50];
