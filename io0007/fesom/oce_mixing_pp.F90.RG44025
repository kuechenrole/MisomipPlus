...
contains
  ...
  subroutine oce_mixing_pp
    ...
    implicit none
    !
    integer     :: col,n,j,node_low,node_up, node, k, n3, i
...
#ifdef use_cavity
    do i=1,myDim_nod2D
     if (Av(i)  .lt.wndmix .and. cavity_flag_nod2d(i).eq.0)  Av(i)=wndmix
     if (Kv(i,1).lt.wndmix .and. cavity_flag_nod2d(i).eq.0) Kv(i,1)=wndmix 
    enddo
#else
RG44025-
