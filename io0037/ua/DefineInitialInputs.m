...
%%
UserVar.MisExperiment='io0037';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0037/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0037';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1099.11';
UserVar.FinalOutputID='1100.00';
%%
...
CtrlVar.TotalTime=1100.00000000000;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0037/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0037/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
