...
oldOceFile='/work/ollie/orichter/MisomipPlus/io0005/fesomdata/io0005.1027.oce.nc';
newOceFile='/work/ollie/orichter/MisomipPlus/io0005/fesomdata/io0005.1027.oce.ini.nc';

oldIceFile='/work/ollie/orichter/MisomipPlus/io0005/fesomdata/io0005.1027.ice.nc';
newIceFile='/work/ollie/orichter/MisomipPlus/io0005/fesomdata/io0005.1027.ice.ini.nc';

oldMeshPath='/work/ollie/orichter/MisomipPlus/io0005/fesommesh/1027.80/';
newMeshPath='/work/ollie/orichter/MisomipPlus/io0005/fesommesh/1027.90/';
...
netcdf.putVar(ncid_out,temp_ID,get_data_out(7,idxOld2New3d));
netcdf.putVar(ncid_out,salt_ID,get_data_out(8,idxOld2New3d));
...
function data_out = get_data_out2(var_ind,idxOld2New)
    ...
    for i=1:n2dNew
        ...
        if any(diff(column)==0)
            ...
            data_out(idx) = fillmissing(column,'linear');
        end
    end
