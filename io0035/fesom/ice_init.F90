!1) Allocate arrays for the ice model
!2) Initialize ice fields

subroutine ice_init
  !sets inital values or reads restart file for ice
  !
  ! Coded by Ralph Timmermann and Qiang Wang
  ! Reviewed by ??
  !----------------------------------------------------------
...
#ifdef use_cavity	
	do i=1,ToDim_nod2d        ! no sea-ice under cavity  
           if(cavity_flag_nod2d(i)==1) then  
	      m_ice(i) = 0.
	      a_ice(i) = 0.
              u_ice(i) = 0.
              v_ice(i) = 0.
