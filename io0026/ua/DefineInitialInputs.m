...
%%
UserVar.MisExperiment='io0026';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0026/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0026';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1001.02';
UserVar.FinalOutputID='1001.03';
%%
...
CtrlVar.TotalTime=1001.25000000000;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0026/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0026/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
