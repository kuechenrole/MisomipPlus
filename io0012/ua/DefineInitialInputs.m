...
%%
UserVar.MisExperiment='io0012';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0012/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0012';
...
CtrlVar.TotalTime=1200.00;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0012/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0012/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
