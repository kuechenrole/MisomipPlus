...
%%
UserVar.MisExperiment='io0041';  % This I use in DefineMassBalance
UserVar.Outputsdirectory='/work/ollie/orichter/MisomipPlus/io0041/uadata'; % This I use in UaOutputs
UserVar.MassBalanceCase='io0041';
UserVar.CouplingStart=0;
UserVar.StartOutputID='1199.11';
UserVar.FinalOutputID='1200.00';
%%
...
CtrlVar.TotalTime=1200.00000000000;
CtrlVar.Restart=1;
CtrlVar.NameOfRestartFiletoWrite=['/work/ollie/orichter/MisomipPlus/io0041/uarst/','Restart',CtrlVar.Experiment,'.mat'];
if UserVar.CouplingStart;
    CtrlVar.ResetTime=1;   
    CtrlVar.RestartTime=1000;
    CtrlVar.NameOfRestartFiletoRead='/work/ollie/orichter/MisomipPlus/io0041/uarst/RestartMismipPlus-spinup_T.mat';
else
    CtrlVar.ResetTime=0;   
...
CtrlVar.MaxNumberOfElements=1000e3;%250e3;           % max number of elements. If #elements larger then CtrlMeshSize/min/max are changed
