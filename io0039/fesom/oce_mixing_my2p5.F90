module o_mixing_my2p5_mod
  ...
  ! Here a simple/approximate way is used to deal with advection and diffusion.
  !
  ...
  subroutine oce_mixing_my2p5
    ...
    do elem=1, myDim_elem3d        
       ...
       if(smagorinsky_visc) then
          ...
          Ah=Ah0
          if(scale_mixing_h) Ah=Ah*(voltriangle(elem2)/scalevol)**(1.0/real(scale_mixing_type_v))
       endif
